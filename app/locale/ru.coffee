...
#    hey_students: "Students, enter the class code from your teacher."
  ...
  play_level:
    ...
    victory_viking_code_school: "Ого, это был тяжелый уровень! Если вы еще не разработчик программ, вам стоит им стать. Вы только что ускорири принятие в Школу Викингов, где вы сможете поднять свои навыки на новый уровень и стать профессиональным веб-разработчиком за 14 недель."
...
#    tip_life_and_polymorphism: "Open Source is like a totally polymorphic heterogeneous structure: All types are welcome."
    tip_mistakes_proof_of_trying: "Наличие ошибок в коде только подтверждает то, что ты прилагаешь усилия."
...
#    tip_self_taught: "I taught myself 90% of what I've learned. And that's normal! - Hank Green"
    tip_luna_lovegood: "Не волнуйся, ты так же нормален как я. - Полумна Лавгуд"
